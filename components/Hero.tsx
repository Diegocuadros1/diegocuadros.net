    ...
    <div className="pb-20 pt-36">
      ...
      <div className="flex-col">
        <div className="flex justify-center relative my-20 z-10">
          <div className="flex w-40 h-11"></div>
          <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
            <h3 className="text-[50px] font-bold ml-[-200px]">Diego</h3>
            <h3 className="text-purple text-[50px] font-bold">Cuadros</h3>

            <p className="text-center md:tracking-wider mb-4 text-small md:text-large lg:text-2xl">
              Creating dreams into reality through programming and business
            </p>
          </div>
        </div>
      </div>
